...
import solve_dlyap_lowrank as sdlyaplr
...
def main_process(args):
	...
	if ("lowrank" in solvers):
		sdlyaplr.RecTrunc(acc, k_iter_max, A, c) #lowrank fixed-point. ! Rank truncation congigured manually in solve_dlyap_lowrank.py !
